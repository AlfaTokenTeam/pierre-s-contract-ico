...
import "./PierreSContract.sol";

contract PierreSContractPreSale {
    PierreSContract public token;
    ...
    function PierreSContractPreSale(
        PierreSContract _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = PierreSContract(_token);
